...
export const MUSHROOM_ENTRIES = [
  { nodeName: 'Cylinder_0', id: 'mushroom_cylinder_0', name: 'Mushroom 1' },
  { nodeName: 'Cylinder.001_1', id: 'mushroom_cylinder_001', name: 'Mushroom 2' },
  { nodeName: 'Cylinder.002_2', id: 'mushroom_cylinder_002', name: 'Mushroom 3' },
  { nodeName: 'Cylinder.003_3', id: 'mushroom_cylinder_003', name: 'Mushroom 4' },
  { nodeName: 'Cylinder.004_4', id: 'mushroom_cylinder_004', name: 'Mushroom 5' },
  { nodeName: 'Cylinder.005_5', id: 'mushroom_cylinder_005', name: 'Mushroom 6' },
  { nodeName: 'Cylinder.007_6', id: 'mushroom_cylinder_007', name: 'Mushroom 7' },
  { nodeName: 'Cylinder.008_7', id: 'mushroom_cylinder_008', name: 'Mushroom 8' },
  { nodeName: 'Cylinder.009_8', id: 'mushroom_cylinder_009', name: 'Mushroom 9' },
  { nodeName: 'Cylinder.010_9', id: 'mushroom_cylinder_010', name: 'Mushroom 10' },
  { nodeName: 'Cylinder.011_10', id: 'mushroom_cylinder_011', name: 'Mushroom 11' },
  { nodeName: 'Cylinder.006_11', id: 'mushroom_cylinder_006', name: 'Mushroom 12' },
  { nodeName: 'Cylinder.012_12', id: 'mushroom_cylinder_012', name: 'Mushroom 13' },
  { nodeName: 'Cylinder.013_13', id: 'mushroom_cylinder_013', name: 'Mushroom 14' },
  { nodeName: 'Cylinder.024_14', id: 'mushroom_cylinder_024', name: 'Mushroom 15' }
];
